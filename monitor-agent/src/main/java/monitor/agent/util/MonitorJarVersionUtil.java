...
public class MonitorJarVersionUtil {
     ...
     * @return
     */
    public static String getHighestMonitorCoreJar(List<String> collectorJars) {
    ...
    public static void main(String[] args) {
        String jar1 = "monitor-core-0.2.1.jar";
        String jar2 = "monitor-core-0.3.4.jar";
        String jar3 = "monitor-core-1.0.1.jar";
        String jar4 = "monitor-core-1.2.6.jar";
        ...
        System.out.println(getHighestMonitorCoreJar(jars));
    }
}